...
class TestCRUDUser:
    ...
    async def test_get_user_by_email(self, db_session: AsyncSession):
        ...
        retrieved_user = await crud.user.get_by_email(db_session, email="email@example.com")
    ...
    async def test_get_user_by_username(self, db_session: AsyncSession):
        ...
        retrieved_user = await crud.user.get_by_username(db_session, username="uniqueusername")
